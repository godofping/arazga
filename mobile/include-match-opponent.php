               ...
               <hr>
                ...
                <div class="container">
                        ...
                        <div class="form-group">
         				...
         				<?php if ($res['matchStatus'] == 'Room is full') { ?>
                   		...
                   		<?php if ($res['matchStatus'] == 'Host is ready') { ?>
                   			<h5 class="text-center font-weight-bold text-primary">Host is ready. Please press ready button for the match to start.</h5>
                   			<button id="readyButton" class="btn btn-block btn-success">Ready</button>
                   		<?php } ?>

                   		<?php if ($res['matchStatus'] == 'Opponent is ready') { ?>
                   			<h5 class="text-center font-weight-bold text-success">You are ready. Please wait for the host to be ready.</h5>
                   		<?php } ?>
                  ...
                  <div class="row mt-3 text-center">
                    <div class="col-12">
                      <a href="mobile-controller.php?from=leave-match&twoPlayerGameHistoryId=<?php echo $id ?>"><button type="button" class="btn btn-block btn-secondary">Leave Match</button></a>
                    </div>
                  </div>
                  <?php } ?>
...
<script type="text/javascript">
	$('#readyButton').click(function(){
		...
		$.post("mobile-controller.php",{from:"opponent-ready",twoPlayerGameHistoryId: "<?php echo $id; ?>",matchStatus: "<?php echo $res['matchStatus'] ?>"}, function(data, status){
