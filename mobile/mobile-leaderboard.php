              ...
              <h5 class="text-center">Leaderboard</h5>
               ...
               <div class="container">
                  ...
                  <div class="row">
                    ...
                    <h6 class="text-center">Top 3 players with the most scores in "Easy" solo player match.</h6>
                    ...
                    <table class="table mt-3">
                      <thead class="thead-light">
                        <tr>
                          ...
                          <th scope="col" width="20%">Total scores</th>
                        </tr>
                      </thead>
                      <tbody>

                        <?php $rank = 1; $qry = mysqli_query($connection, 'SELECT *, SUM(score) AS scores FROM solo_player_game_history_table  WHERE difficulty = "Easy" GROUP BY playerId ORDER BY scores DESC LIMIT 3'); while ($res = mysqli_fetch_assoc($qry)) {
                  ...
                  <div class="row">
                    ...
                    <h6 class="text-center">Top 3 players with the most scores in "Average" solo player match.</h6>
                    ...
                    <table class="table mt-3">
                      ...
                      <tbody>
                        ...
                        <?php $rank = 1; $qry = mysqli_query($connection, 'SELECT *, SUM(score) AS scores FROM solo_player_game_history_table  WHERE difficulty = "Average" GROUP BY playerId ORDER BY scores DESC LIMIT 3'); while ($res = mysqli_fetch_assoc($qry)) {
                          $qry1 = mysqli_query($connection, "select * from player_view where playerId = '" . $res['playerId'] . "'");
                          $res1 = mysqli_fetch_assoc($qry1);
                          ?>
                        <tr>
                  ...
                  <div class="row">
                    ...
                    <h6 class="text-center">Top 3 players with the most scores in "Difficult" solo player match.</h6>
                    ...
                    <table class="table mt-3">
                      ...
                      <tbody>
                        ...
                        <?php $rank = 1; $qry = mysqli_query($connection, 'SELECT *, SUM(score) AS scores FROM solo_player_game_history_table  WHERE difficulty = "Difficult" GROUP BY playerId ORDER BY scores DESC LIMIT 3'); while ($res = mysqli_fetch_assoc($qry)) {
                          $qry1 = mysqli_query($connection, "select * from player_view where playerId = '" . $res['playerId'] . "'");
                          $res1 = mysqli_fetch_assoc($qry1);
                          ?>
                        <tr>
