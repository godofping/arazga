    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 pt-5">
          <h1 class="text-center">ARAZGA ADMIN LOGIN PAGE</h1>
        </div>
       </div>
      ...
      <div class="row pt-3">
        ...
        <div class="col-md-4">
          ...
          <h6 class="text-center">
            Download <a href="apk/offline.apk" download="">offline</a> apk. 
             
            Download <a href="apk/online.apk" download="">online</a> apk.
             </h6>
        </div>
        <div class="col-md-4">
