...
--
-- Host: localhost:3306
-- Generation Time: Jan 14, 2019 at 03:11 PM
...
--
ALTER TABLE `average_question_table`
  MODIFY `averageQuestionId` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
...
--
ALTER TABLE `difficult_question_table`
  MODIFY `difficultQuestionId` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=302;
