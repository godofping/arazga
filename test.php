	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        ...
	        ?>" hidden="">
	        <input type="text" name="from" value="add-question-average" hidden="">
	        </form>
	      </div>
	    </div>
	  </div>
		...
		for ($i=1; $i <= 6 ; $i++) { ?>
			...
			while ($res = mysqli_fetch_assoc($qry)) { ?>
				...
				else
				{
					...
					$verdict =  "not okay" . ">length of ans: " . strlen($modifiedAnswer) . " to add > " . $add .  " length of scrambled: " . strlen($modifiedScrambledWord);
				}

				?>

				<p>Modified Initial scrambled letter: <?php echo $modifiedScrambledWord; ?></p>
				<p>Modified Answer: <?php echo $modifiedAnswer; ?></p>
				<p>Verdict: <?php echo $verdict; ?></p>
